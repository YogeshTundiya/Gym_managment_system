...
import { LayoutDashboard, Calendar, Dumbbell, Activity, Settings, LogOut, QrCode, PanelRightClose, PanelRightOpen, Moon, Sun, Menu, Bell, User, X } from "lucide-react";
                    ...
                    <aside className="fixed top-0 left-0 w-72 h-full bg-white dark:bg-dark-bg border-r border-gray-200 dark:border-dark-border flex flex-col shadow-2xl">
                        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-dark-border">
                            <Link href="/" className="flex items-center gap-3">
                                ...
                                <span className="font-serif text-lg font-bold text-gray-900 dark:text-white tracking-tight">FitZone</span>
                            </Link>
                            <button
                                onClick={() => setIsMobileMenuOpen(false)}
                        ...
                        <div className="p-4 border-t border-gray-100 dark:border-dark-border flex flex-col gap-2">
                            ...
                            <Link
                                href="/portal"
                                onClick={() => setIsMobileMenuOpen(false)}
                                className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors"
                            >
                                <LogOut className="w-5 h-5 min-w-[20px]" />
                                <span>Sign Out</span>
                            </Link>
